package com.prog.client.entity.custom;
...
public class EdgedTridentEntityModel extends Model {
    private final ModelPart root;

    public EdgedTridentEntityModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData2.addChild("left_spike", ModelPartBuilder.create().uv(4, 3).cuboid(-2.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F), ModelTransform.NONE);
        ...
        modelPartData2.addChild("right_spike", ModelPartBuilder.create().uv(4, 3).mirrored().cuboid(1.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F), ModelTransform.NONE);
