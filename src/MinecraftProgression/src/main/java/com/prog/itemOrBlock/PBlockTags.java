...
public class PBlockTags {
    ...
    public static final TagKey<Block> NEEDS_EVERGLOOM_TOOL = createExternalTag(XIDs.FABRIC, getToolLevelPath(PMiningLevels.EVERGLOOM));
    public static final TagKey<Block> NEEDS_END_TOOL = createExternalTag(XIDs.FABRIC, getToolLevelPath(PMiningLevels.END));
