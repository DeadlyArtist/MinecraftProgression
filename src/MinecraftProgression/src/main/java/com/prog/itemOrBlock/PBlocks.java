...
public class PBlocks {
    ...
    public static final Block VERUM_BLOCK = register("VERUM_BLOCK", new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 12.0F).requiresTool().luminance(5)), ItemGroup.BUILDING_BLOCKS, (modelSupplier, self) -> modelSupplier.registerCubeAllModelTexturePool(self), (lootProvider, self) -> lootProvider.addDrop(self)).tags(List.of(BlockTags.PICKAXE_MINEABLE, PBlockTags.NEEDS_VERUM_TOOL, BlockTags.DRAGON_IMMUNE)).finished();
    public static final Block VERUM_ORE = register("VERUM_ORE", new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 12.0F).requiresTool().luminance(5)), ItemGroup.BUILDING_BLOCKS, (modelSupplier, self) -> modelSupplier.registerCubeAllModelTexturePool(self), (lootProvider, self) -> lootProvider.addDrop(self, PItems.RAW_VERUM)).tags(List.of(BlockTags.PICKAXE_MINEABLE, PBlockTags.NEEDS_PRIMAL_NETHERITE_TOOL, BlockTags.DRAGON_IMMUNE)).finished();
    // Not needed lol
