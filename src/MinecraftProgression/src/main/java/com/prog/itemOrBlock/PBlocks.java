...
public class PBlocks {
    ...
    public static final Block VERDITE_BLOCK = register("VERDITE_BLOCK", new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 10.0F).requiresTool().luminance(5)), ItemGroup.BUILDING_BLOCKS, (modelSupplier, self) -> modelSupplier.registerCubeAllModelTexturePool(self), (lootProvider, self) -> lootProvider.addDrop(self)).tags(List.of(BlockTags.PICKAXE_MINEABLE, PBlockTags.NEEDS_VERDITE_TOOL, BlockTags.DRAGON_IMMUNE)).finished();
    public static final Block VERDITE_ORE = register("VERDITE_ORE", new Block(FabricBlockSettings.of(Material.STONE).strength(5.0F, 10.0F).requiresTool().luminance(5)), ItemGroup.BUILDING_BLOCKS, (modelSupplier, self) -> modelSupplier.registerCubeAllModelTexturePool(self), (lootProvider, self) -> lootProvider.addDrop(self, block -> BlockLootTableGenerator.oreDrops(block, PItems.RAW_VERDITE))).tags(List.of(BlockTags.PICKAXE_MINEABLE, PBlockTags.NEEDS_PRIMAL_NETHERITE_TOOL, BlockTags.DRAGON_IMMUNE)).finished();
