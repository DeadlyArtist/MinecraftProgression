...
public class PBlocks {
    ...
    public static final Block VERUM_BLOCK = registerBlock("VERUM_BLOCK", new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).requiresTool().luminance(5)), ItemGroup.BUILDING_BLOCKS, (modelSupplier, self) -> modelSupplier.registerCubeAllModelTexturePool(self), (lootProvider, self) -> lootProvider.addDrop(self), List.of(BlockTags.PICKAXE_MINEABLE, PBlockTags.NEEDS_VERUM_TOOL));
    public static final Block VERUM_ORE = registerBlock("VERUM_ORE", new Block(FabricBlockSettings.of(Material.METAL).strength(5.0F, 6.0F).requiresTool().luminance(5)), ItemGroup.BUILDING_BLOCKS, (modelSupplier, self) -> modelSupplier.registerCubeAllModelTexturePool(self), (lootProvider, self) -> lootProvider.addDrop(self, PItems.RAW_VERUM), List.of(BlockTags.PICKAXE_MINEABLE, PBlockTags.NEEDS_PRIMAL_NETHERITE_TOOL));
