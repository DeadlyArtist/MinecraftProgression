...
public enum PTierData {
    ...
    EVERGLOOM(8, PMiningLevels.EVERGLOOM, PArmorMaterials.EVERGLOOM, PToolMaterials.EVERGLOOM, BowMaterials.EVERGLOOM, CrossbowMaterials.EVERGLOOM, ShieldMaterials.EVERGLOOM, FishingRodMaterials.EVERGLOOM, ShearsMaterials.EVERGLOOM, TridentMaterials.EVERGLOOM, PItemTags.EVERGLOOM, PItemTags.EVERGLOOM_OR_HIGHER),
