...
public enum PTierData {
    STEEL(3, MiningLevels.IRON, PArmorMaterials.STEEL, PToolMaterials.STEEL, BowMaterials.STEEL, CrossbowMaterials.STEEL, FishingRodMaterials.STEEL, TridentMaterials.STEEL, PItemTags.STEEL, PItemTags.STEEL_OR_HIGHER),
    ULTIMATE_DIAMOND(4, MiningLevels.DIAMOND, PArmorMaterials.ULTIMATE_DIAMOND, PToolMaterials.ULTIMATE_DIAMOND, BowMaterials.ULTIMATE_DIAMOND, CrossbowMaterials.ULTIMATE_DIAMOND, FishingRodMaterials.ULTIMATE_DIAMOND, TridentMaterials.ULTIMATE_DIAMOND, PItemTags.ULTIMATE_DIAMOND, PItemTags.ULTIMATE_DIAMOND_OR_HIGHER),
    REFINED_OBSIDIAN(5, PMiningLevels.REFINED_OBSIDIAN, PArmorMaterials.REFINED_OBSIDIAN, PToolMaterials.REFINED_OBSIDIAN, BowMaterials.REFINED_OBSIDIAN, CrossbowMaterials.REFINED_OBSIDIAN, FishingRodMaterials.REFINED_OBSIDIAN, TridentMaterials.REFINED_OBSIDIAN, PItemTags.REFINED_OBSIDIAN, PItemTags.REFINED_OBSIDIAN_OR_HIGHER),
    TITAN(6, PMiningLevels.TITAN, PArmorMaterials.TITAN, PToolMaterials.TITAN, BowMaterials.TITAN, CrossbowMaterials.TITAN, FishingRodMaterials.TITAN, TridentMaterials.TITAN, PItemTags.TITAN, PItemTags.TITAN_OR_HIGHER),
    PRIMAL_NETHERITE(7, PMiningLevels.PRIMAL_NETHERITE, PArmorMaterials.PRIMAL_NETHERITE, PToolMaterials.PRIMAL_NETHERITE, BowMaterials.PRIMAL_NETHERITE, CrossbowMaterials.PRIMAL_NETHERITE, FishingRodMaterials.PRIMAL_NETHERITE, TridentMaterials.PRIMAL_NETHERITE, PItemTags.PRIMAL_NETHERITE, PItemTags.PRIMAL_NETHERITE_OR_HIGHER),
    VERUM(8, PMiningLevels.VERUM, PArmorMaterials.VERUM, PToolMaterials.VERUM, BowMaterials.VERUM, CrossbowMaterials.VERUM, FishingRodMaterials.VERUM, TridentMaterials.VERUM, PItemTags.VERUM, PItemTags.VERUM_OR_HIGHER);
    ...
    PTierData(int level, int miningLevel, ArmorMaterial armorMaterial, ToolMaterial toolMaterial, BowMaterial bowMaterial, CrossbowMaterial crossbowMaterial, FishingRodMaterial fishingRodMaterial, TridentMaterial tridentMaterial, TagKey<Item> tierAttribute, TagKey<Item> tierOrHigherAttribute) {
        this.level = level;
    ...
    public static PTierData getTier(Item item) {
        ...
        } else if (item instanceof TieredCrossbowItem crossbow) {
            return crossbowMaterialMap.get(crossbow.material);
