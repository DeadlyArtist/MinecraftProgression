...
public class Upgrades {
    ...
    static {
        ...
        register(Items.GHAST_TEAR, List.of(UEffectMapper.best(3), UEffectMapper.helmet(UEffect.increment(XEntityAttributes.LAVA_VISIBILITY, 100))));
        register(Items.HONEY_BLOCK, UEffectMapper.boots(UEffect.increment(PEntityAttributes.IMPACT_ABSORPTION, 2)));
        register(Items.PHANTOM_MEMBRANE, UEffectMapper.best());
        register(Items.WITHER_ROSE, UEffectMapper.best(2));
        register(Items.HEART_OF_THE_SEA, List.of(UEffectMapper.best(3), UEffectMapper.chestplate(UEffect.increment(XEntityAttributes.WATER_VISIBILITY, 50))));
        register(Items.EMERALD, UEffectMapper.best());
        register(Items.LAPIS_LAZULI, UEffectMapper.best());
        register(Items.MUSIC_DISC_PIGSTEP, UEffectMapper.best(3));
        register(Items.SCUTE, UEffectMapper.best(2));
        register(Items.TURTLE_HELMET, UEffectMapper.helmet(UEffect.increment(EntityAttributes.GENERIC_ARMOR)));
        register(Items.SLIME_BALL, UEffectMapper.boots(UEffect.increment(PEntityAttributes.IMPACT_ABSORPTION, 1)));
        register(Items.SLIME_BLOCK, UEffectMapper.boots(UEffect.increment(PEntityAttributes.IMPACT_ABSORPTION, 1)));
        register(Items.ENDER_PEARL, UEffectMapper.best());
        register(Items.ENDER_EYE, UEffectMapper.best());
        register(Items.TOTEM_OF_UNDYING, UEffectMapper.protection(2));
        ...
        register(Items.GOAT_HORN, UEffectMapper.chestplate(UEffect.increment(XEntityAttributes.LUNG_CAPACITY, 5)));
        ...
        register(Items.WITHER_SKELETON_SKULL, UEffectMapper.helmet(UEffect.increment(EntityAttributes.GENERIC_ARMOR, 2)));
        register(Items.NETHER_STAR, UEffectMapper.best(5));
        register(Items.TORCH, UEffectMapper.helmet(UEffect.increment(PEntityAttributes.LUMINANCE, 14)));
        register(Items.GOLDEN_BOOTS, UEffectMapper.boots(UEffect.increment(PEntityAttributes.PIGLIN_LOVED, 0.25)));
        register(Items.GOLDEN_CHESTPLATE, UEffectMapper.chestplate(UEffect.increment(PEntityAttributes.PIGLIN_LOVED, 0.25)));
        register(Items.GOLDEN_HELMET, UEffectMapper.helmet(UEffect.increment(PEntityAttributes.PIGLIN_LOVED, 0.25)));
        register(Items.GOLDEN_LEGGINGS, UEffectMapper.leggings(UEffect.increment(PEntityAttributes.PIGLIN_LOVED, 0.25))); // All 4 gold armor items required for piglin loved to take effect
        ...
        register(Items.GOLDEN_SWORD, UEffectMapper.sword(UEffect.increment(EntityAttributes.GENERIC_ATTACK_SPEED, 0.1)));
        ...
        register(Items.NAUTILUS_SHELL, UEffectMapper.protection(2));
