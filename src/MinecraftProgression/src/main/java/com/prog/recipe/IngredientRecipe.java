...
public class IngredientRecipe<I extends Inventory> implements NBTCRecipe<I> {
    ...
    public interface Factory<R extends IngredientRecipe<?>> {
        R create(Identifier id, Ingredient base, Ingredient ingredient, ItemStack result, IngredientRecipe.Serializer<R> serializer);
    }

    public static class Serializer<R extends IngredientRecipe<?>> implements RecipeSerializer<R> {
        private final IngredientRecipe.Factory<R> factory;

        public Serializer(IngredientRecipe.Factory<R> factory) {
